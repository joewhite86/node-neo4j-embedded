 ...
 * @param {Object} deletes Can either be a comma seperated list of identifiers or an array.
 */
...
QueryBuilder.prototype.execute = function(params, cb) {
  ...
  async.parallel([function(next) {
    ...
    if(that._returns.length) {
      countQuery = that.buildCountQuery();
      // console.log('query: %s, params: %s', countQuery, JSON.stringify(params));
    ...
    // console.log('query: %s, params: %s', query, JSON.stringify(params));
...
/**
 * @chainable
 * Add returnings to the query.
 * @param {Object} returns Can either be a comma seperated list of identifiers or an array or just a single identifier.
 */
